...
The showcase / documentation site for **[@shelfwood/talos-ui][pkg]** — the
...
- **Package repo:** <https://github.com/j-shelfwood/talos-ui> (`@shelfwood/talos-ui`)
...
The site pins `@shelfwood/talos-ui` in `apps/showcase/package.json`. To pull a new
...
[pkg]: https://www.npmjs.com/package/@shelfwood/talos-ui
