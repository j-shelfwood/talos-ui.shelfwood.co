...
For the round single-select variant see [`.talos-radio`](/docs/forms/radio/); for
the sliding HUD toggle see [`.talos-switch`](/docs/forms/switch/). Group several
under a [`.talos-fieldset`](/docs/forms/fieldset/).
